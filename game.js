...
update_stats = function () {
	...
	if (document.cookie.search('NaN') > -1 || document.cookie.search('miss') <0) {
		document.cookie = `score=${0}; expires=Thu, 18 Dec 2999 12:00:00 UTC; path=/;`
		document.cookie = `miss=${0}; expires=Thu, 18 Dec 2999 12:00:00 UTC; path=/;`
		document.cookie = `good=${0}; expires=Thu, 18 Dec 2999 12:00:00 UTC; path=/;`
		document.cookie = `great=${0}; expires=Thu, 18 Dec 2999 12:00:00 UTC; path=/;`
	...
	document.getElementById('miss').innerHTML = parseInt(document.getElementById('miss').innerHTML) + parseInt(get_cookie('miss'));
	document.getElementById('good').innerHTML = parseInt(document.getElementById('good').innerHTML) + parseInt(get_cookie('good'));
	document.getElementById('great').innerHTML = parseInt(document.getElementById('great').innerHTML) + parseInt(get_cookie('great'));
	document.getElementById('perfect').innerHTML = parseInt(document.getElementById('perfect').innerHTML) + parseInt(get_cookie('perfect'));
	document.getElementById('marvelous').innerHTML = parseInt(document.getElementById('marvelous').innerHTML) + parseInt(get_cookie('marvelous'));
	
	score = calc_score(parseInt(get_cookie('miss')), parseInt(get_cookie('good')), parseInt(get_cookie('great')), parseInt(get_cookie('perfect')), parseInt(get_cookie('marvelous')));
...
loadthings = function() {
	...
	*/
	...
	document.getElementById(mobileprefix+'instructions').style.display = 'block'
	...
	document.getElementById(mobileprefix+'fish').src = 'sprites/spinning_fish_meme_transparent.webp';
